...
export const endpoints = {
  ...
  promotions: {
    ...
    campaignDetail: (id: string) => `/promotions/campaigns/${id}/`,
    campaignGenerate: (id: string) => `/promotions/campaigns/${id}/generate-codes/`,
    codes: "/promotions/codes/",
    codeDetail: (id: string) => `/promotions/codes/${id}/`,
    redemptions: "/promotions/redemptions/",
  },
  subscriptions: {
    plans: "/subscriptions/plans/",
    planDetail: (idOrCode: string) => `/subscriptions/plans/${idOrCode}/`,
    me: "/subscriptions/me/",
    list: "/subscriptions/",
    subscribe: "/subscriptions/subscribe/",
    cancel: "/subscriptions/cancel/",
    adminList: "/subscriptions/admin/",
  },
  revenue: {
    dashboard: "/revenue/dashboard/",
    sources: "/revenue/sources/",
    sourceDetail: (code: string) => `/revenue/sources/${code}/`,
    sourceToggle: (code: string) => `/revenue/sources/${code}/toggle/`,
    config: "/revenue/config/",
    configUpdate: "/revenue/config/update/",
    rules: "/revenue/commission-rules/",
    ruleDetail: (id: string) => `/revenue/commission-rules/${id}/`,
    ruleVersions: (id: string) => `/revenue/commission-rules/${id}/versions/`,
    ruleRollback: (id: string) => `/revenue/commission-rules/${id}/rollback/`,
    ruleValidate: "/revenue/commission-rules/validate-dsl/",
    audit: "/revenue/audit/",
    evaluations: "/revenue/evaluations/",
    entries: "/revenue/entries/",
    previewCommission: "/revenue/preview-commission/",
  },
  accounts: {
