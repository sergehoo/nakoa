...
def issue_otp(
    *,
    ...
    # Rate limit : pas plus de 3 OTP / 5 min pour un même identifier
    ...
    # Envoi via la couche notifications (importé localement pour éviter import circulaire)
...
def enable_2fa(user) -> tuple[str, str, list[str]]:
    ...
    # Codes de secours (10 codes hex à usage unique)
